...
| [`site-tutor.md`](site-tutor.md) | Have the agent build a small public teaching website from public sources, then check its facts and give it a rule. Includes a classroom version. | 20-30 min |
